          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="mb-5 flex lg:mb-0">
              ...
              <div>
                ...
                <p className="text-base text-white/70">info@example.com</p>
                <p className="text-base text-white/70">sales@yourmail.com</p>
              </div>
            </div>
          </div>
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="mb-5 flex lg:mb-0">
              ...
              <div>
                ...
                <p className="text-base text-white/70">+09 098 2345 332</p>
                <p className="text-base text-white/70">+77 904 5673 345</p>
              </div>
            </div>
          </div>
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
