        ...
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4 lg:w-1/2">
            <div className="mb-12 max-w-[560px] lg:mb-8">
              <span className="mb-4 inline-block rounded bg-yellow px-3 py-1 text-base font-medium text-black">
                Some Fun Facts
              </span>
...
const StatsItem = ({ user, title }) => {
  return (
    <div className="w-full px-3 xs:w-1/2 md:px-4">
      <div className="group mb-6 rounded-[5px] bg-white px-4 py-6 text-center shadow-three hover:bg-primary dark:bg-dark md:mb-8">
